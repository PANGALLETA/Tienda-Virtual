...
<aside class="app-sidebar">
  <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?php echo media(); ?>/images/administrador.png" alt="User Image">
    <div>
      <p class="app-sidebar__user-name">Julian Andres</p>
